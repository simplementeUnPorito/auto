...
\insertarfigurawide{./img/zn_step_response.png}{Respuesta al escalón en lazo abierto (curva azul oscuro) con la tangente (linea roja punteada) en el punto de máxima pendiente (punto rojo) y la Respuesta al escalon en lazo cerrado (curva celeste) usando los valores de \(K_p,T_i\) y \(T_d\) obtenidos por el metodo.}{fig:zn_step_out}{1}
