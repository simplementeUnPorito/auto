...
\paragraph{Lazo abierto en cascada.}
La ganancia de lazo abierto total (desde la entrada de la primera etapa hasta la salida final) es el producto:

\[
	G_{o}(s) = G_{o1}(s)G_{o2}(s)G_{3}(s)
\]

	

El signo se vuelve positivo:

\begin{equation}
	G_{o}(s) = \frac{R_{f1}R_{f2}}{R_{i1}R{i2}}\frac{K}{(1+sR_{f1}C_{f1})(1+sR_{f2}C_{f2})}
	\label{eq:producto1}
\end{equation}
