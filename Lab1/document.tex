...
% preámbulo
\usepackage{graphicx}
% (opcional) mejor control de flotantes anchos al fondo
\usepackage{stfloats} % permite [!b] en figure*
...
\usepackage{booktabs}
\usepackage{tabularx}
\usepackage{balance}   % para balancear las columnas antes del strip si querés
...
\usepackage{cuted} % preámbulo
% === Dependencias mínimas ===
\usepackage{cuted}    % para strip
\usepackage{listings} % ya lo usás
\usepackage{xparse}   % interfaz de comandos
\usepackage{etoolbox} % utilidades
% (no requiere pgf/tikz)
