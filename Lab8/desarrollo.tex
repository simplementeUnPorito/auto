...
\subsection{Elección del tiempo de muestreo $T_s = 1.1948~\text{ms}$, usado en laboratorios anteriores}
...
\& \quad D = J
\]
\subsection{Obtención de las matrices discretas $A$, $B$, $C$ y $D$}
...
\subsection{Diagrama de bloques del sistema discretizado}
...
\subsection{Verificación de la controlabilidad y observabilidad del sistema}
...
\subsection{Comparar los resultados obtenidos con las simulaciones realizadas en \texttt{MATLAB}}
