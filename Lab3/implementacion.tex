...
\insertarfigura{img/circuitoPsoc.png}
...
\insertarfigura{img/C2/esfuerzo.png}{Compensador de adelanto + integrador: referencia tipo escalon (traza cian), esfuerzo (traza violeta) y salida de la planta (traza verde).}{fig:c2}{1}                                                                                                                              
