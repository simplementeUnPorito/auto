...
\NewDocumentCommand{\insertarfigurawide}{O{!htb} m m m m}{%
	\begin{figure*}[#1]
		\centering
...
% ==== Codificación y fuentes (XeLaTeX/LuaLaTeX) ====
\usepackage{fontspec}
\defaultfontfeatures{Ligatures=TeX}
\setmainfont{Latin Modern Roman} % o la que uses
\usepackage{listings}
\usepackage{listingsutf8}

% PREÁMBULO (si no lo tenés)
...
% Mapeo de Unicode frecuentes en los listados:
\lstset{literate=
	{á}{{\'a}}1 {é}{{\'e}}1 {í}{{\'i}}1 {ó}{{\'o}}1 {ú}{{\'u}}1 {ñ}{{\~n}}1
	{Á}{{\'A}}1 {É}{{\'E}}1 {Í}{{\'I}}1 {Ó}{{\'O}}1 {Ú}{{\'U}}1 {Ñ}{{\~N}}1
	{°}{{\textdegree}}1 {º}{{\textordmasculine}}1 {µ}{{\textmu}}1
	{Ω}{{$\Omega$}}1 {ω}{{$\omega$}}1 {σ}{{$\sigma$}}1 {φ}{{$\varphi$}}1
	{·}{{$\cdot$}}1 {±}{{$\pm$}}1
