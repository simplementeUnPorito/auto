...
\begin{enumerate}[label=2.\arabic*.]
	...
	Finalmente, al multiplicar por $(1-z^{-1})$, se obtiene la expresión general de la planta discretizada:
	\begin{equation}
	...
	Con los valores $a = \tfrac{1}{81\,000 \cdot 200 \cdot 10^{-9}}$ y $b = \tfrac{1}{15 \cdot 10^{3} \cdot 100 \cdot 10^{-9}}$, y considerando $K = 1$, se obtienen los siguientes coeficientes:
	\[
