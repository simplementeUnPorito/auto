...
algo = validatestring(algo, {'menu','designer','opt_intra','pp_obs','pp_obs_int','dlqr','dlqr_int','lqg','lqg_int'});
...
switch algo
    ...
    case "pp_obs_int"
        ...
        S = sim_estado_espacio(S, Ad,Bd,Cd_,Dd_, K,L,Kr, obsType, true, Ki, u_sat, N, subN);
   ...
   case "lqg"
    ...
    case "dlqr_int"
        ...
        S = sim_estado_espacio(S, Ad,Bd,Cd_,Dd_, K,[],Kr, "predictor", true, Ki, u_sat, N, subN);
    ...
    case "lqg_int"
        ...
        S = sim_estado_espacio(S, Ad,Bd,Cd_,Dd_, K,Lk,Kr, obsType, true, Ki, u_sat, N, subN);
