Dado que la planta identificada (ecuación \ref{eq:Gz_identificada}) presenta polos ubicados fuera del círculo unitario, el sistema en lazo abierto resulta inestable en el dominio discreto. En consecuencia, cualquier diseño de control debe garantizar que los polos del lazo cerrado queden estrictamente dentro del círculo unitario para asegurar estabilidad interna.
...
{Esfuerzo y altura de la implementación práctica de lugar de raices}
