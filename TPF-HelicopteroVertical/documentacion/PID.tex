...
\onecolumn
\insertarfigura{img/PID/RstaPID.png}{La respuesta al escalón del PID.}{fig:rstaPID}{0.7}

\insertarfigura{img/PID/EsfuerzoPID.png}{El esfuerzo del PID.}{fig:EsfPID}{0.7}
\twocolumn