...
Los parámetros implementados del controlador PID fueron:
...
En la simulación del modelo lineal (figura \ref{fig:rstaPID}) se obtuvo:
...
En la implementación experimental (figura \ref{fig:PID_practica})
se observaron los siguientes valores de sobreimpulso según la altura
de referencia:
...
Se observa que el tiempo de subida coincide prácticamente con el
predicho por el modelo, mientras que el sobreimpulso disminuye
progresivamente a medida que aumenta la altura de operación.
