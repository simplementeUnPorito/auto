...
\onecolumn
%\insertarfigura{img/PID/RstaPIDPractica.png}{La respuesta con el controlador PID.}{fig:RstaPID_practica}{0.5}

%\insertarfigura{img/PID/EsfuerzoPIDPractica.png}{El esfuerzo del con el controlador PID.}{fig:EsfPID_practica}{0.5}
\twocolumn

\[
K_p = \textbf{[Completar]}, \quad
T_i = \textbf{[Completar]}, \quad
T_d = \textbf{[Completar]}, \quad
N = \textbf{[Completar]}
\]
