...
\onecolumn
\insertarfigura{img/PID/PID_Practico.png}{Implementación práctica del PID.}{fig:PID_practica}{0.8}

%\insertarfigura{img/PID/EsfuerzoPIDPractica.png}{El esfuerzo del con el controlador PID.}{fig:EsfPID_practica}{0.8}
\twocolumn
