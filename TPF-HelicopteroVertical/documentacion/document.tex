...
\begin{document}
	...
	\begin{IEEEkeywords}
		control de altura, sistemas dinámicos, identificación de sistemas, control PID, Lugar de raices, Diagrama de Bode, control en espacio de estados, LQG, PSoC, TFMini, ESC, PWM
	\end{IEEEkeywords}
	...
	\input{caracPlanta.tex}
	
	\input{diagramaSist.tex}
	
	
	\section{Modelado físico del sistema}
	\input{modeladoPlanta.tex}
	
	% ============================================================
	\section{Métodos Clásicos de Control}
	% ============================================================
	\input{control0.1.tex}
	
	% ============================================================
	\section{Métodos Modernos de Control}
	% ============================================================
	
	\input{control0.2.tex}
	\balance
	\clearpage
