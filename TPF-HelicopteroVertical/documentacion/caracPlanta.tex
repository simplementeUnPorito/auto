...
\begin{itemize}
	...
	\item \textbf{Frecuencia de lectura:} configurable, típicamente en el rango de \(50\,\text{Hz}\), \(300\,\text{Hz}\) y hasta \(1000\,\text{Hz}\), según la configuración utilizada durante las distintas prácticas.
\end{itemize}
