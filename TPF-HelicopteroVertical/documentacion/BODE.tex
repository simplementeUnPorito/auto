...
Para el diseño se empleó el modelo discreto identificado previamente:
...
El análisis se realizó utilizando la herramienta \texttt{controlSystemDesigner}
de MATLAB, permitiendo examinar los diagramas de Bode del lazo abierto
$L(z)=G(z)$.
