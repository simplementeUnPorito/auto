...
un estimador para reconstruir el vector de estados a
...
%\insertarfigura{img/SSi/SSi_pzmap.png}{Mapa de polos: planta, sistema aumentado y dinámica del observador.}{fig:ssi_pzmap}{1}