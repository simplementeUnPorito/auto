...
#define U0  1
#define U1 -0.663381520928124//-(p0+p1)
#define U2 -0.336618479071876//p0*p1
#define U3 0

#define E0  3.33443950539959
#define E1  -2.76348149790686  //-(z0+z1)
#define E2 0.430377166796216//z0*z1
#define E3 0
